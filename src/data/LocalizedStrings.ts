...
export const en:ILocalizedStrings = {
	...
	searchHelpText: 'Search for works by title such as བཀའ་འགྱུར།, authors by name such as བུ་སྟོན།, texts by title such as  བཀྲ་ཤིས་ཆེན་པོའི་མདོ།, or BDRC RIDs such as MW22084. Unicode Tibetan must be used, except in the case of an RID.',
	PDF:'Download',
