...
export const en:ILocalizedStrings = {
	...
	librarySourceDescription: 'If you are using the BDRC Mobile app in China, please choose the servers in China so that images and PDFs are visible and downloadable.',
	Access: 'Access',
