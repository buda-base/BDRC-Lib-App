		...
		return (
		  <li className="list-item list-item--material" onClick={this.handleSelect}>
		    ...
		    <div className="list-item__center list-item--material__center">
		      <div className="list-item__title list-item--material__title title" style={{lineHeight:'36px'}}>{this.props.item.title?this.props.item.title:this.props.item.nodeId}</div>
