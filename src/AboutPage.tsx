...
const ChineseAbout = (props:{appState:AppState}) => 
  <div className="aboutPageContent">
    ...
    {props.appState.updater.storedLibraryMetaData?.tosUrl && <p>请参考 <a href={props.appState.updater.storedLibraryMetaData?.tosUrl+"?uilang=zh"} target="_blank">使用条款</a>中 的其他信息。</p>}
  </div>
;
...
const TibetanAbout = (props:{appState:AppState}) => 
  <div className="aboutPageContent">
    ...
    {props.appState.updater.storedLibraryMetaData?.tosUrl && <p>ཞིབ་ཕྲ་མཁྱེན་འདོད་ཚེ་ང་ཚོའི་<a href={props.appState.updater.storedLibraryMetaData?.tosUrl+"?uilang=bo"} target="_blank">དྲ་ཚིགས་ཀྱི་སྒྲིག་གཞི་</a>ཡིག་ཆ་ལ་གཟིགས་པར་ཞུ།</p>}
  </div>
;
...
const EnglishAbout = (props:{appState:AppState}) => 
  <div className="aboutPageContent">
    ...
    {props.appState.updater.storedLibraryMetaData?.tosUrl && <p>Please refer to the <a href={props.appState.updater.storedLibraryMetaData?.tosUrl+"?uilang=en"} target="_blank">terms of use</a> for additional information.</p>}
  </div>
;
