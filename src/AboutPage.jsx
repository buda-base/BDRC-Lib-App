...
export default class AboutPage extends Component {
  ...
  render() {    
    if('en'===this.props.strings.id) {
      return <EnglishAbout />;
    } else if('cn'===this.props.strings.id) {
      return <ChineseAbout />;
    } else  {
      return <TibetanAbout />;
    }
...
const ChineseAbout = () => 
  <div className="aboutPageContent">
    ...
    <p>请参考 <a href="https://www.tbrc.org/#!footer/about/tou" target="_blank">使用条款</a>中 的其他信息。</p>
  </div>
;
...
const TibetanAbout = () => 
  <div className="aboutPageContent">
    ...
    <p>ཞིབ་ཕྲ་མཁྱེན་འདོད་ཚེ་ང་ཚོའི་<a href="https://www.tbrc.org/?locale=bo#!footer/about/tou" target="_blank">དྲ་ཚིགས་ཀྱི་སྒྲིག་གཞི་</a>ཡིག་ཆ་ལ་གཟིགས་པར་ཞུ།</p>
  </div>
;
...
const EnglishAbout = () => 
  <div className="aboutPageContent">
    ...
    <p>Please refer to the <a href="https://www.tbrc.org/#!footer/about/tou" target="_blank">terms of use</a> for additional information.</p>
  </div>
;